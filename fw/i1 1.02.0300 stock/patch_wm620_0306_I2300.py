...
if __name__ == "__main__":
    ...
    if ((sn_parts[0] != sn_parts[1]) or (sn_parts[2] != sn_parts[3])):
		...
		print("updated this sucker to work on 03.03.09.18")
		exit(1)
    for i in range (0,4):
	...
	#   updated i2 0305 v 03.03.09.18 = 18090303
	#   0x12 = 18  
	#   0x09 = 9 
	
    # HardCoded version of the version in some FC function
    # orig p.patchByteAtAddress(0x51E44C,hex_parts[0])  #0x09 = 9
    # orig p.patchByteAtAddress(0x51E458,hex_parts[3])  #0x3 = 3
